...
| **Grave recovery** | Finds the bodies and missing-in-action markers in a world, tells you where each is and how much it's holding, and brings one back within reach. It moves the *grave*, not the loot — nothing is converted or re-homed, so no item can land somewhere that won't accept it. You loot it in-game. |
...
iuut rescue-grave       # find a body/grave marker and bring it back within reach
...
- **400 xUnit tests** — round-trip parse/serialize, edit services, recovery, blob codecs,
